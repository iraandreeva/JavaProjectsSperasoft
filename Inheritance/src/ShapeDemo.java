public class ShapeDemo {
    ...
    public static void main(String[] args) {
        ...
        shapes[0].toString();
        System.out.println("Circle's area is = " + ((Circle2)shapes[0]).getArea());
        shapes[1].toString();
        System.out.println("Circle's area is = " + ((Circle2)shapes[1]).getArea());
        shapes[2].toString();
        ...
        shapes[4].toString();
        System.out.println("Sqare's perimeter is = " + ((Square)shapes[4]).getPerimeter());
        shapes[5].toString();
        System.out.println("Sqare's perimeter is = " + ((Square)shapes[5]).getPerimeter());
    }
}
